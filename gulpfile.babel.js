 ...
 */
gulp.task('browser-sync', ['sass', 'js', /* 'foundation-js',  'jquery-js',*/ 'imgmin', 'jekyll-build'], function() {
    browserSync({
        server: {
            baseDir: '_site'
        },
...
gulp.task('js', ['sass'], function() {
  ...
  del(["assets/js/scripts.*"])

  var bundler = browserify({
      entries: '_assets/js/scripts/all.js',
      debug: true
  });
  ...
  return gulp.src(['node_modules/babel-polyfill/dist/polyfill.js', '_assets/js/scripts/all.js'])
    //.pipe(jshint())
...
gulp.task('watch', function () {
    gulp.watch('_assets/img/**', ['imgmin']).on("change", browserSync.reload);;
...
gulp.task('production', ['sass', 'js', 'imgmin', /* 'foundation-js', 'jquery-js' ,*/ 'jekyll-build']);
